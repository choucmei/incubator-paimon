...
//                ") PARTITIONED BY (dt, hr)").print();
        ...
        streamTableEnvironment.executeSql("insert into `paimon_catalog`.`default`.`tb_all_type` select id,a,b,c,d,h,i,j,k,l,m,n,o,p,p0,p3,p6,p7,q,q0,q3,q6,q12,q13,r,r0,r3,r6,r12,r13,DATE_FORMAT(CURRENT_ROW_TIMESTAMP(),'yyyyMMdd'),DATE_FORMAT(CURRENT_ROW_TIMESTAMP(),'HHmm') from GenOrders").print();
